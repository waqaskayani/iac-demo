...
module "eks" {
    ...
    cluster_endpoint_private_access_sg                = [ aws_security_group.eks_cluster_sg.id, data.aws_security_group.worker_sg.id ]  # List of sg ids that can access cluster. Edit "eks-cluster-sg" security group
    ...
    worker_groups = [
        {
            ...
            asg_max_size         = 3
            asg_min_size         = 1
            additional_security_group_ids = [ aws_security_group.worker_sg.id ]
